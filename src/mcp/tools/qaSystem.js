// QA System for BambiSleep knowledge agent
 ...
 * @returns {object} Answer object with text and sources
 */
export function answerQuestion(question) {
  // Find template matching the question
  ...
  if (answerInfo.sources && answerInfo.sources.length > 0) {
    ...
    const answer = `Based on available information: ${bestSource.summary}`;
    const citations = formatCitations(answerInfo.sources);
